...
/*Elemento CVC Configuração do IMask */
const securtyCode = document.querySelector('#security-code')
const securyCodePattern = {
    mask: "0000"
}
const securtyCodeMasked = IMask(securtyCode, securyCodePattern)

/*Elemento Expiração Configuração do IMask */
...
/*Elemento de Validação do Número de Cartão */
...
securtyCodeMasked.on("accept", () => {
    updateSecurtyCode(securtyCode.value)
})
...
function updateCardNumber (number) {
    ...
    ccNumber.innerText = number.length === 0 ? "1234 5678 9012 3453" : number
}
